...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--visdom_display_id', type=int, default=0, help='set value larger than 0 to display with visdom.')
        ...
        parser.add_argument('--gan_type', type=str, default='lsgan', help='GAN loss [wgan-gp|lsgan|gan]')
        ...
        parser.add_argument('--func', type=int, default=0, help='specific target images.eg 1,2,3...8')
        parser.add_argument('--tes', type=int, default=0, help='for test')
